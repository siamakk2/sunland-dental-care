...
const paths = ["", "/dr-emami", "/about", "/dental-implants", "/cosmetic-dentistry", "/invisalign", "/general-dentistry", "/pricing", "/faq", "/new-patients", "/contact", "/emergency-dentist", "/full-arch-implants", "/dentures", "/root-canals", "/teeth-whitening", "/insurance-financing", "/blog", "/services", "/privacy-policy", "/terms-of-use", "/hipaa-notice", "/accessibility", "/periodontal-treatment", "/sedation-implant-dentistry", ...POSTS.map((p) => `/blog/${p.slug}`), ...CITIES.map((c) => `/${c.slug}`)];
