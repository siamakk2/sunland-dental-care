...
(function () {
  ...
  var CONFIG = {
    ...
    theme: {
      bg: '#ffffff', panelBg: '#f5f5f4', card: '#f5f5f4', track: '#e5e3e0',
      line: '#e5e3e0', lineHi: '#cfccc8',
      text: '#17130f', muted: '#3d3934', dim: '#54504a',
      accent: '#c8102e', accentHi: '#9c0c24', accentInk: '#ffffff',
      accentFade: 'rgba(200,16,46,.35)', accentWash: 'rgba(200,16,46,.12)',
      shadow: 'rgba(23,19,15,.16)',
